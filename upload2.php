...
include "inc.php";
$fstat = find_ftp_file($ftppath . $dirname);
?>
...
<?
if (! $fstat) die("<strong>$nofilefounderror</strong>");
else echo $notesheading; 
?>
</strong></th>
</tr>
<tr>
<th class="content-text" scope="row" align="left">
 <ol>
  <li><strong><?=$u2note1; ?></strong></li>
  <li><strong><?=$u2note2; ?></strong></li>
  <li><strong><?=$u2note3; ?></strong></li>
  </ol>
</th>
</tr>
</table>
...
<table width="500"  border="0" align="center" cellpadding="3" cellspacing="1" class="border">
  <tr>
    ...
    <td align="left" valign="middle" nowrap class="content" scope="row"><input name="File1" type="hidden" id="File1" size="30" value="<?=$fstat[0]; ?>"><?=$fstat[0]; ?> (<?=round($fstat[1] / 1024 / 1024, 2); ?> MB)</td>
  </tr>
  <tr>
